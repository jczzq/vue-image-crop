(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-image-crop"] = factory();
	else
		root["vue-image-crop"] = factory();
...
// CONCATENATED MODULE: ./src/m-image-crop.vue?vue&type=template&id=546d4f84&
...
m_image_crop.install = function (Vue) {
  if (m_image_crop.installed) return;
  m_image_crop.installed = true;
  Vue.component(m_image_crop.name, m_image_crop);
};

if (window.Vue) {
  m_image_crop.install(window.Vue);
}

/* harmony default export */ var src = (m_image_crop);
...
//# sourceMappingURL=vue-image-crop.umd.js.map